		...
		<div class="card p-3 col-lg-6 m-4" style="border-radius:15px">
			<div class="row">
				<div class="kiri col-lg-4 ">
					<img src="fhoto.jpg" class="img-fluid col-12 rounded">
				</div>
				...
				<div class="kanan col-lg-8">
					...
					<div class="col-12 py-3">
						...
						<span class="badge rounded-pill text-bg-primary">PPGL</span>
						<span class="badge rounded-pill text-bg-danger">TJKT</span>
						<span class="badge rounded-pill text-bg-warning">Perhotelan</span>
					</div>
						<div class="row">
						<div class="col-8">
